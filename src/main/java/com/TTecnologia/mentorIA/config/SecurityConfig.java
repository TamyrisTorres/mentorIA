...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .requestMatchers( HttpMethod.POST,"createUser/register", "/css/**", "/js/**").permitAll()
                .requestMatchers(HttpMethod.POST,"auth/login", "/css/**", "/js/**").permitAll()
                .requestMatchers(HttpMethod.POST,"api/ia/ask", "/css/**", "/js/**").permitAll()// URLs públicas
